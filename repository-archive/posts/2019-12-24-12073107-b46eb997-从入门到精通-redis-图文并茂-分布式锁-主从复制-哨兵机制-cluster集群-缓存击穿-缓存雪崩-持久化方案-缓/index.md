{
  ...
  "date": "2019-12-24",
  "description": "导读 篇幅较长，干货十足，阅读需要花点时间，全部手打出来的字，难免出现错别字，敬请谅解。珍惜原创，转载请注明出处，谢谢~！ 学习之前，先附上一张知识脑图，百度上找哒~~~ NoSql介绍与Redis介绍 什么是Redis? Redis**是用**C语言**开发的一个**开源**的高性能**键值对**",
  "tags": [
    "Redis"
  ],
...
　　学习之前，先附上一张知识脑图，百度上找哒~~~

![](./images/images/img_001_197373fb9f46.jpg)

![](./images/images/img_002_63715e2c9d7e.png)
...
![](./images/images/img_003_31d616c3eec5.jpg)
...
![](./images/images/img_004_988dfb7d73b8.jpg)
...
![](./images/images/img_005_48734cd1d01d.jpg)
...
![](./images/images/img_006_229e0ed2dd84.jpg)
...
![](./images/images/img_007_29131a11f850.jpg)
...
![](./images/images/img_008_258b6c38f0fc.png)

### 重启服务

![](./images/images/img_009_e56ca3dc475c.png)

## 前端启动

- 启动命令：redis-server，直接运行bin/redis-server将以前端模式启动。

![](./images/images/img_010_008674b2e018.jpg)
...
![](./images/images/img_011_37a37e2d036b.png)
...
![](./images/images/img_012_ffb72e4e99d9.png)

![](./images/images/img_013_d9be6ec6e10f.png)
...
![](./images/images/img_014_09a726125e23.png)
...
![](./images/images/img_015_a36eb8a67263.png)
...
![](./images/images/img_016_f2c46ff31e4f.png)
...
![](./images/images/img_017_7755fabfd0fe.png)
...
![](./images/images/img_018_417f34f8d410.png)

####  增加指定的整数

语法：**INCRBY key increment**

![](./images/images/img_019_7a6718229df5.png)

####  递减数值

语法：**DECR key**

![](./images/images/img_020_5e9760eedab7.png)

#### 减少指定的整数 

语法：**DECRBY key decrement**

![](./images/images/img_021_5d6d2ab156ee.png)
...
![](./images/images/img_024_b460aa9b24f1.png)
...
![](./images/images/img_025_67527377beb3.png)
...
![](./images/images/img_026_70619a679a0b.png)
...
**
![](./images/images/img_027_20ec9b07cea8.png)**
...
![](./images/images/img_028_bb53349294a2.png)

####  一次设置多个字段值

语法：**HMSET key field value [field value ...]**

![](./images/images/img_029_dee6b5715617.png)
...
![](./images/images/img_030_8d8b5286b828.png)
...
![](./images/images/img_031_bf147f239a40.png)

####  一次可以获取多个字段值

语法：**HMGET key field [field ....]**

![](./images/images/img_032_b1a527ef6b9c.png)

#### 获取所有字段值

语法：**HGETALL key**

![](./images/images/img_033_3816ad934aa3.png)
...
![](./images/images/img_034_fd4add5d7344.png)

###  增加数字

语法：**HINCRBY key field increment**

![](./images/images/img_035_6abc63e603f8.png)

###  判断字段是否存在

语法：**HEXISTS key field**

![](./images/images/img_036_ede2ae38d315.png)
...
![](./images/images/img_037_d3507bc9aebc.png)

###  获取字段数量

语法：**HLEN key**

![](./images/images/img_038_6cab2332741f.png)
...
![](./images/images/img_039_107fc7c9d086.png)
...
![](./images/images/img_040_3243b1946f4d.png)
...
![](./images/images/img_041_0196fc00e965.png)

![](./images/images/img_042_53a8473e6624.png)
...
![](./images/images/img_043_412302b1352f.png)

####  向列表右边添加元素

语法：**RPUSH key value [value ....]**

![](./images/images/img_044_98c2de98ddcc.png)
...
![](./images/images/img_045_a9d38e75313d.png)
...
![](./images/images/img_046_c4a0f7016339.png)

### 获取列表中元素的个数

语法：**LLEN key**
![](./images/images/img_047_2471a4b9fd30.png)
...
![](./images/images/img_048_a5c68148986d.png)
...
![](./images/images/img_049_a3670c669bae.png)

###  将元素从一个列表转移到另一个列表中

语法：**RPOPLPUSH source destination**

![](./images/images/img_050_ea8e47fef2d6.png)
...
![](./images/images/img_051_91d3bde4664d.png)
...
![](./images/images/img_052_1393c6efc1c1.png)
...
![](./images/images/img_053_bb5e180f505e.png)

### 获取集合中的所有元素 

语法：**SMEMBERS key**

![](./images/images/img_054_1e6027d90241.png)

###  判断元素是否在集合中

语法：**SISMEMBER key member**

![](./images/images/img_055_0880548fa644.png)
...
![](./images/images/img_056_7500abb57dff.png)

 语法：**SDIFF key [key ...]**

![](./images/images/img_057_c6c5f689396b.png)

#### 集合的交集运算 A∩B

属于A且属于B的元素构成的集合。 

![](./images/images/img_058_d8b7af53c538.png)

 语法：**SINTER key [key ...]**

![](./images/images/img_059_9720695ad4f0.png)

#### 集合的并集运算 A ∪ B

属于A或者属于B的元素构成的集合

![](./images/images/img_060_3e7d7ae6eea1.png)

 语法：**SUNION key [key ...]**

![](./images/images/img_061_a55a38930d24.png)

### 获取集合中的元素个数

语法：**SCARD key**

![](./images/images/img_062_1b4367324c1d.png)
...
![](./images/images/img_063_93b075063392.png)
...
![](./images/images/img_064_336bacf49341.png)
...
![](./images/images/img_065_ca4da0799924.png)

 如果需要获取元素的分数的可以在命令尾部加上WITHSCORES参数

###
![](./images/images/img_066_13b71453f5e4.png) 获取元素的分数

语法：**ZSCORE key member**

![](./images/images/img_067_90e44e31089c.png)
...
![](./images/images/img_068_6d3455e77087.png)

###  获取指定分数范围的元素

语法：**ZRANGEBYSCORE key min max [WITHSCORES] [LIMIT offset count]**

![](./images/images/img_069_096a60dcb310.png)
...
![](./images/images/img_070_cddf4573abd3.png)

###  获取集合中元素的数量

语法：**ZCARD key**

![](./images/images/img_071_483e794f6de9.png)

###  获得指定分数范围内的元素个数

语法：**ZCOUNT key min max**

![](./images/images/img_072_490a956152c3.png)

###  按照排名范围删除元素

语法：**ZREMRANGEBYRANK key start stop**

![](./images/images/img_073_759c2ef3402c.png)

###  按照分数范围删除元素

语法：**ZREMRANGEBYSCORE key min max**

![](./images/images/img_074_93832375eac5.png)
...
![](./images/images/img_075_fded4182e3a8.png)
...
![](./images/images/img_076_bea632ced1ba.png)
...
![](./images/images/img_077_cf806ba890ae.png)

![](./images/images/img_078_b7b3d71ec0df.png)
...
**
![](./images/images/img_079_dcc0839aa5cf.png)**

-  Redis类型错误(运行期错误)

![](./images/images/img_080_7a47dcc4a4ee.png)
...
![](./images/images/img_081_677379dde07b.png)
...
![](./images/images/img_082_8a53559eeccb.png)
...
**
![](./images/images/img_083_158e0ce049d8.png)**
...
![](./images/images/img_084_b5fa74c46f13.png)
...
![](./images/images/img_085_99d3956bd426.png)

## redis-cluster投票：容错 

**
![](./images/images/img_086_93d408502091.png)**
...
![](./images/images/img_087_caca1bd973b6.png)

### 修改redis.conf配置文件，打开Cluster-enable yes 

![](./images/images/img_088_c24592d9f257.png)
...
![](./images/images/img_089_525cc9d2c3c6.png)

#### 查看集群节点发现7007已加到集群中 

![](./images/images/img_090_1540dc4411f5.png)
...
![](./images/images/img_091_a5582e622d8f.png)
...
![](./images/images/img_092_46def3d60335.png)

** 输入500，表示要分配500个槽**

第三步：输入接收槽的节点id

![](./images/images/img_093_93791ee1dc83.png)
...
![](./images/images/img_094_33d6ce6a42cd.png)

 输入：all

第五步：输入yes开始移动槽到目标节点id

![](./images/images/img_095_8be80cf71f03.png)
...
![](./images/images/img_096_72e55c9e2020.png)
...
![](./images/images/img_097_dd5173cb71ba.png)
...
# SpringBoot整合Redis、Mybatis(附源码)

[点我直达](https://www.cnblogs.com/chenyanbin/p/13515268.html)

# Redis高级项目实战，分布式锁详讲(附源码)

[点我直达](https://www.cnblogs.com/chenyanbin/p/13506946.html)

# Redis实战秒杀(附源码)

[点我直达](https://www.cnblogs.com/chenyanbin/p/13587508.html)
