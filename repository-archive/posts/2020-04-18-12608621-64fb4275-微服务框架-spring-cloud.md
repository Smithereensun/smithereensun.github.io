...
![](images/img_001_785d5a9993ff.png)

![](images/img_002_7d25f6c3c687.png)

![](images/img_003_ef1f87788ba3.png)
...
![](images/img_004_e8e61d42ea48.png)

## 服务消费者项目

### 创建工程

![](images/img_005_4905accaa9d7.png)

![](images/img_006_d5008208c4b4.png)
...
![](images/img_007_ea635a994cbb.png)

### 项目结构图

![](images/img_008_a6e9cec39666.png)

## Restlet Client测试

安装教程：[点我直达](https://www.cnblogs.com/chenyanbin/p/12620116.html)

![](images/img_009_0857c0cfb50e.png)
...
![](images/img_010_aecbb65192fc.png)

![](images/img_011_570567eb5e41.png)

![](images/img_012_17254728e492.png)
...
![](images/img_013_076a3d67b8f9.png)

### 项目启动测试

![](images/img_014_21b785c64114.gif)

### 项目结构图

![](images/img_015_64d00f09b35f.png)
...
![](images/img_016_599fb430a996.gif)

![](images/img_017_a11b092663aa.gif)

### 添加依赖

![](images/img_018_b47ad730aa3f.png)
...
![](images/img_019_cc7329d5a0b9.png)

![](images/img_020_6e0ac86e6175.png)

### 修改客户端在注册中心名称(可忽略)

![](images/img_021_f8cfe4b54c91.png)

## actuator完善微服务info

### 问题展示

![](images/img_022_c87ba6c80006.gif)

　　可以看出，**点击**微服务状态的**超链接**，可以**看到404错误页**，是因为**在提供者配置文件中**，**未设置actuator的info监控终端所致**。

### 添加提供者依赖

![](images/img_023_850a1c98bafb.png)
...
![](images/img_024_6d1233214ac2.png)

### 测试

![](images/img_025_2517d9265b9d.gif)
...
![](images/img_026_695af3726a6f.png)
...
![](images/img_027_0ba3d1ff2d64.png)
...
![](images/img_028_990c175f65ea.png)
...
![](images/img_029_15e02d4050a7.png)
...
![](images/img_030_5092743b57b5.png)

### 启动类上添加注解

![](images/img_031_97f84c2c2f2f.png)

### 项目启动

![](images/img_032_49e01274edf9.gif)
...
![](images/img_033_0ddfad30806a.png)
...
![](images/img_034_49cee2d6e787.gif)
...
![](images/img_035_b70983166955.png)

###  复制并修改EurekaServer

　　复制3份01-eurekaserver-8083，并重命名，分别为：02-eurekaserver-8123；02-eurekaserver-8456；02-eurekaserver-8789；

![](images/img_036_78962e4fbac7.png)

### 修改EurekaServer配置文件

![](images/img_037_b22b02b0ca7d.png)

**注：“,”隔开的中间不能有空格！！！集群中3个项目都要相应修改！！！**

### 修改客户端配置

![](images/img_038_d8fd22626e11.png)

### 运行访问

![](images/img_039_d5a31355901e.png)

![](images/img_040_e5103bff47f0.gif)
...
![](images/img_041_02ed94227439.png)
...
![](images/img_042_92ddbf1f95f5.png)
...
![](images/img_043_f5362b6ba871.png)
...
![](images/img_053_97e5e50f5967.png)
...
![](images/img_065_c02e8822c89c.png)
...
![](images/img_066_f07e743cfb8f.png)

**注：实际中一个方法对应一个处理函数**

4、启动类上添加注解

![](images/img_067_55bb5b6a397e.png)

### 测试

　　为了演示方法，只开启eureka注解中心和消费者

![](images/img_068_29e7508dea01.png)
...
![](images/img_069_676dc9b73280.png)

### 接口类上指定降级处理器类

![](images/img_070_ad47f389d7d5.png)

### 修改配置文件

　　在配置文件中添加如下内容，没有自动提示

![](images/img_071_3fbd2c09a9c6.png)

### 测试

![](images/img_072_619ed921668c.png)
...
![](images/img_073_6e42ef7f95ae.png)

## 基本用法

### 创建zuul网关服务器

![](images/img_074_e171ff8294ac.png)

![](images/img_075_8611d720e3d0.png)

### 修改配置文件

![](images/img_076_7e265a405b16.png)

### 修改启动类

![](images/img_077_3f9559f44eaa.png)

### 启动测试

![](images/img_078_e1993744f39d.png)

![](images/img_079_bcc6ad5a8f44.png)

![](images/img_080_c6a7ae32895c.png)

## 设置zull路由映射规则

　　上面测试，我们发现，直接将服务名称暴露给了消费者，为了保护和隐藏服务名称，可以为其配置一个映射路径，将这个映射路径暴露给消费者即可。

![](images/img_081_890e248d29a8.png)
...
![](images/img_082_be4ebd2e4303.png)

![](images/img_083_52706bef8091.png)
...
![](images/img_084_ae8ae80d11ff.png)

![](images/img_085_bc19413f8a0e.png)

![](images/img_086_1c5190341288.png)

此时通过微服务名称已无法访问到微服务了，但通过映射路径是可以正常访问的

### 忽略所有微服务名称

![](images/img_087_ea1d7671a593.png)
...
![](images/img_088_bdda29b24354.png)
