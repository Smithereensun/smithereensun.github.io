...
![](images/img_001_49e7539ca121.gif)

　　从上我们可以看到byName注入，自动获取bean的id等于video的，当修改bean的id的值为video2的时候，就自动注入不到值类

# byType演示

![](images/img_002_ee4371f4e95c.gif)

下面演示注册2次bean的，会抛异常

![](images/img_003_d0d744917bc1.gif)
...
![](images/img_004_82a2016e1388.png)

修改applicationContext.xml

![](images/img_005_aab995297a64.png)

![](images/img_006_b5c6cb2c99ec.gif)

底层也是根据byType注入的

![](images/img_007_cc2ff7138389.gif)
