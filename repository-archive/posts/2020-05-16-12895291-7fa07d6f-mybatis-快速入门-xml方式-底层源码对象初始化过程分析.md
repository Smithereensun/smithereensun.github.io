...
![](images/img_001_e20b2d852ce5.png)
...
![](images/img_002_8e215f0b1481.gif)
...
![](images/img_003_7cf1a335a2cc.png)

###  表数据

![](images/img_004_84838ea0094d.png)

## Mybatis环境搭建 
![](images/img_005_5ef15a5359f5.png)
![](images/img_006_6b4d13e183a3.png)

![](images/img_007_3ab3640a75e4.png)

![](images/img_008_5b20f7248ccb.png)
...
![](images/img_009_4c30b38ce679.png)

### 测试

![](images/img_010_a2ee52667d95.gif)

## 功能实现

### 根据用户id查询一个用户信息

![](images/img_011_7fb8a3e911ed.png)

![](images/img_012_086a4d43a485.png)

![](images/img_013_ba2b80cc120d.png)

![](images/img_014_9a08b6026376.gif)

### 根据用户名称模糊查询用户信息列表

![](images/img_015_59ccaedebcc0.png)

![](images/img_016_df051a25c547.png)

### 添加用户

![](images/img_017_d2c8129da845.png)

![](images/img_018_9a8a2dea19e1.png)
...
![](images/img_019_1bc70f79a13f.png)

![](images/img_020_78577d32420b.png)

![](images/img_021_be8c681314b7.gif)

### 删除用户

![](images/img_022_ae6f39a20467.png)

![](images/img_023_33e70a325f6d.png)

![](images/img_024_85eb75a8dd48.gif)
...
![](images/img_025_01c630d69337.png)

### 测试 

![](images/img_026_6f340f979dc4.gif)
...
![](images/img_027_f750442302de.png)
...
![](images/img_028_abadfcf7e72d.png)

### 批量指定别名(推荐)

![](images/img_029_1417ab5358a5.png)

**注：可以写多个package，但是package和typeAlias不能一起用！！！**

### 单个指定别名(**typeAlias**)

![](images/img_030_7de740bf091a.png)
...
![](images/img_031_c136de42ed2d.png)
...
![](images/img_032_3621c4191cfd.png)
...
![](images/img_033_b60c0f44d734.png)
...
![](images/img_034_42b6a6d801a4.png)

![](images/img_035_e2b93bbbf0dc.png)
...
![](images/img_036_90635cfbd1d3.gif)
...
![](images/img_037_9531c5fd79b6.png)
...
![](images/img_038_cd15104d5c5f.png)
...
![](images/img_039_68e91c7d9986.gif)

![](images/img_040_4e551d78a6ee.gif)

![](images/img_041_dd6875b3b573.gif)

### 构建者模式使用地方

![](images/img_042_966b09fcbc2c.png)

### XPath使用地方

![](images/img_043_88dce627eea3.png)

### 补充

![](images/img_044_b449b6740ada.png)

![](images/img_045_8b1acf880451.png)

**注意：此处用到了遍历list节点，因为映射文件有很多的select、update、delete标签哦~**

![](images/img_046_62c8bd9668cf.png)

## 打开session会话

　　我们可以看到，SqlSessionFactory是一个接口，里面有很多重载方法

![](images/img_047_3d4e4f2bac69.gif)

### SqlSessionFactory接口重载说明

![](images/img_048_781ee66a9b45.png)
...
![](images/img_049_18e6a92e05c7.gif)

**细心的小伙伴此时会问，问什么跟踪源码的时候，他不是有两个实现类吗，为什么要跟踪上面一个，不跟踪下面那个，是因为创建SqlSessionFactory的时候，默认返回的是DefaultSqlSessionFactory**

![](images/img_050_40dbd798e695.gif)

## 跟踪selectOne

![](images/img_051_1c62ef818c1c.gif)

### selectList分析

![](images/img_052_9b324de34332.png)

我们跟踪下，是如何从Configuration全局配置文件中(**从Map中获取**)，获取MapperStatement的；注：**这个全局配置文件(configuration)是在初始化SqlSessionFactory时加载的**

![](images/img_053_46566b182f64.gif)

接下来我们跟踪下，是如何解析传递的参数的，分3种处理情况，分别为：集合、list、其他；注：**参数类型与xxxMapper.xml的parameterType类型想对应，传什么类型，走什么情况**

![](images/img_054_1017992304c5.gif)

![](images/img_055_c1c781c42300.png)

### 跟踪executor.query

　　先走下面那个实现类，在走上面那个实现类

![](images/img_056_5fda35515714.png)

**为什么先走下面那个实现类呢？**看gif，先委托下面那个实现类

![](images/img_057_d3132ac3699a.gif)

## 设置参数绑定

　　打个断点，调试下就知道了！！

![](images/img_058_be21fbb8911d.gif)

![](images/img_059_d82b7630aa0c.gif)
