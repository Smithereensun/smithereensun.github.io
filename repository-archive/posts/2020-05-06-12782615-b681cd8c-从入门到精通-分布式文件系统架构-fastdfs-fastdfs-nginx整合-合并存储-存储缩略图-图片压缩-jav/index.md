...
![](./images/images/img_001_66d00dedcff2.png)
...
![](./images/images/img_002_e76803fb634e.png)
...
![](./images/images/img_003_1fed1037af69.png)
...
![](./images/images/img_004_183b835f13a5.png)

　　每个Storage写文件后，同时会写一份binlog，binlog里不包含文件数据，只包含文件名等元信息，这份binlog用于后台同步，Storage会记录向group内其他Storage同步的进度，以便重启后能接上次的进度继续同步；进度以时间戳的方式进行记录，所以最好能保证集群内所有Server的时钟保持同步。

## 文件下载流程分析

![](./images/images/img_005_20863fdb3665.png)
...
![](./images/images/img_006_5d968c0123d9.png)
...
![](./images/images/img_007_ef79997fd8c2.png)
...
![](./images/images/img_008_d080f7a9b069.png)
...
![](./images/images/img_009_2b681a1452ba.png)

### 创建文件夹，用于存放安装包

![](./images/images/img_010_15a266648f64.png)

将下载后的包放到该目录下

### 解压缩

![](./images/images/img_011_6996a011d2f4.png)

### 编译并安装

![](./images/images/img_012_4e10ba584907.png)
...
![](./images/images/img_013_c020a9db0b34.png)

### 解压缩

![](./images/images/img_014_1bac7c3d29ca.png)

### 编译与安装

![](./images/images/img_015_576a40c73f42.png)

### 拷贝FastDFS目录下的文件到/etc/fdfs目录下

![](./images/images/img_016_520c5e5209b7.png)
...
![](./images/images/img_017_e8e5065ae9f1.png)
...
![](./images/images/img_018_db0df88167ee.png)

修改：base_path

![](./images/images/img_019_9c15efec287f.png)

修改：store_path*

![](./images/images/img_020_5f33426ebfc1.png)

**补充：为什么要设置多个store_path*呢？linux如果磁盘不够用的话，用户可以加硬盘，然后设置多个store_path***

修改：tracker_server

![](./images/images/img_021_04e630992e2e.png)
...
![](./images/images/img_022_da8e832a9bad.png)
...
![](./images/images/img_023_3e2e0afdede9.png)
...
![](./images/images/img_024_f8aa976d2c70.png)
...
![](./images/images/img_025_85f0efd2cf8a.png)
...
![](./images/images/img_026_32fec3fdb1a2.png)
...
![](./images/images/img_027_5360cd8f8a2d.png)
...
![](./images/images/img_028_c5f51c580cda.png)
...
![](./images/images/img_029_3e4bc6a396ad.png)

**　此时这个地址是访问不到的，需要与Nginx整合使用，方可访问该文件！**

### 验证两台机器都上传成功

![](./images/images/img_030_288898ecee53.png)
...
![](./images/images/img_031_1dc1b3dcde65.png)

## 执行configure配置

![](./images/images/img_032_feebb09fafc1.png)

## 编译与安装

![](./images/images/img_033_1d443276e327.png)
...
![](./images/images/img_034_366f0a134f61.png)
...
![](./images/images/img_035_98de28a2e8bf.gif)
...
![](./images/images/img_036_da3b6c2f6d34.png)
...
![](./images/images/img_037_2bfa668c5c12.png)

## 解压缩

![](./images/images/img_038_03c885819ee6.png)

## 修改config文件(关键一步)

![](./images/images/img_039_7bd3f4821eb6.png)

### 修改第6、15行的内容

![](./images/images/img_040_b8e1ff8a5f5a.png)
...
![](./images/images/img_041_5a189ef3cfd0.png)

## 重新编译与安装

![](./images/images/img_042_b73e48d8c004.png)
...
![](./images/images/img_043_584e447930c2.png)

## 修改nginx.conf配置 

![](./images/images/img_044_5967f5c5bb53.png)

## 搞定

一样可以正常访问

![](./images/images/img_045_29305d53b9c5.png)
...
![](./images/images/img_046_985a6110cccf.png)
...
![](./images/images/img_047_5f362319c402.gif)
...
![](./images/images/img_048_e534787301f5.png)

###  use_trunk_file改true

![](./images/images/img_049_17c728071e72.png)
...
![](./images/images/img_050_5f7e3b42a331.png)
...
![](./images/images/img_051_431990c82418.png)
...
![](./images/images/img_052_bc3cfdc06dd2.png)

#### 然后在/cyb/data/img/下存放一张图片

![](./images/images/img_053_94b4f80cdbe1.png)

注意：该图片一定要有读取权限，要不然nginx是读取不到的！！！

![](./images/images/img_054_c9b90419663f.png)
...
![](./images/images/img_055_f37818f307f6.gif)
...
![](./images/images/img_056_b34033cdd6e4.png)

### 测试(FastDFS图片)

![](./images/images/img_057_98d28973257a.gif)
...
![](./images/images/img_058_275169ae37b8.png)
...
![](./images/images/img_059_db610d995ee7.gif)

细心的小伙伴发现，水印没有出现，术印出没出来有个阈值：600x600(版本不同，阈值可能不同)

![](./images/images/img_060_e7f22c42aad5.png)
...
![](./images/images/img_061_261545dcf087.png)
