{
  ...
  "has_date": true,
  "description": "全局锁 执行后，整个数据库就处于只读状态了，这时其他线程执行以下操作，都会被阻塞： 对数据的增删改操作，比如 insert、delete、update等语句； 对表结构的更改操作，比如 alter table、drop table 等语句。 全局锁主要应用于做**全库逻辑备份**，这样在备份数据库期",
  "tags": [
    "数据库",
    "MySQL"
  ],
  "source": "local-markdown-library",
  "source_path": "database/mysql/02-lock1-lockofmysql - MySQL锁机制：从全局锁到行级锁的深度解读.md",
  "date": "2025-05-17"
...
![](/imported/markdown/2025-05-17-markdown-1fda4507-mysql锁机制-从全局锁到行级锁的深度解读/images/d80f5efe7a90-202404261902808.png)
...
![](/imported/markdown/2025-05-17-markdown-1fda4507-mysql锁机制-从全局锁到行级锁的深度解读/images/f0d985a38ec5-202404261902850.png)
...
![](/imported/markdown/2025-05-17-markdown-1fda4507-mysql锁机制-从全局锁到行级锁的深度解读/images/d861ae31106d-202404261902835.png)
