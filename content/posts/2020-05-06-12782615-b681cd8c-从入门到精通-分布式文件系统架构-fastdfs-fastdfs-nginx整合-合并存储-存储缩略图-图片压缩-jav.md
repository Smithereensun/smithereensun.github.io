...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_001_66d00dedcff2.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_002_e76803fb634e.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_003_1fed1037af69.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_004_183b835f13a5.png)

　　每个Storage写文件后，同时会写一份binlog，binlog里不包含文件数据，只包含文件名等元信息，这份binlog用于后台同步，Storage会记录向group内其他Storage同步的进度，以便重启后能接上次的进度继续同步；进度以时间戳的方式进行记录，所以最好能保证集群内所有Server的时钟保持同步。

## 文件下载流程分析

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_005_20863fdb3665.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_006_5d968c0123d9.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_007_ef79997fd8c2.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_008_d080f7a9b069.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_009_2b681a1452ba.png)

### 创建文件夹，用于存放安装包

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_010_15a266648f64.png)

将下载后的包放到该目录下

### 解压缩

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_011_6996a011d2f4.png)

### 编译并安装

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_012_4e10ba584907.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_013_c020a9db0b34.png)

### 解压缩

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_014_1bac7c3d29ca.png)

### 编译与安装

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_015_576a40c73f42.png)

### 拷贝FastDFS目录下的文件到/etc/fdfs目录下

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_016_520c5e5209b7.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_017_e8e5065ae9f1.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_018_db0df88167ee.png)

修改：base_path

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_019_9c15efec287f.png)

修改：store_path*

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_020_5f33426ebfc1.png)

**补充：为什么要设置多个store_path*呢？linux如果磁盘不够用的话，用户可以加硬盘，然后设置多个store_path***

修改：tracker_server

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_021_04e630992e2e.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_022_da8e832a9bad.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_023_3e2e0afdede9.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_024_f8aa976d2c70.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_025_85f0efd2cf8a.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_026_32fec3fdb1a2.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_027_5360cd8f8a2d.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_028_c5f51c580cda.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_029_3e4bc6a396ad.png)

**　此时这个地址是访问不到的，需要与Nginx整合使用，方可访问该文件！**

### 验证两台机器都上传成功

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_030_288898ecee53.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_031_1dc1b3dcde65.png)

## 执行configure配置

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_032_feebb09fafc1.png)

## 编译与安装

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_033_1d443276e327.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_034_366f0a134f61.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_035_98de28a2e8bf.gif)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_036_da3b6c2f6d34.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_037_2bfa668c5c12.png)

## 解压缩

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_038_03c885819ee6.png)

## 修改config文件(关键一步)

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_039_7bd3f4821eb6.png)

### 修改第6、15行的内容

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_040_b8e1ff8a5f5a.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_041_5a189ef3cfd0.png)

## 重新编译与安装

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_042_b73e48d8c004.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_043_584e447930c2.png)

## 修改nginx.conf配置 

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_044_5967f5c5bb53.png)

## 搞定

一样可以正常访问

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_045_29305d53b9c5.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_046_985a6110cccf.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_047_5f362319c402.gif)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_048_e534787301f5.png)

###  use_trunk_file改true

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_049_17c728071e72.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_050_5f7e3b42a331.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_051_431990c82418.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_052_bc3cfdc06dd2.png)

#### 然后在/cyb/data/img/下存放一张图片

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_053_94b4f80cdbe1.png)

注意：该图片一定要有读取权限，要不然nginx是读取不到的！！！

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_054_c9b90419663f.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_055_f37818f307f6.gif)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_056_b34033cdd6e4.png)

### 测试(FastDFS图片)

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_057_98d28973257a.gif)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_058_275169ae37b8.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_059_db610d995ee7.gif)

细心的小伙伴发现，水印没有出现，术印出没出来有个阈值：600x600(版本不同，阈值可能不同)

![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_060_e7f22c42aad5.png)
...
![](/imported/posts/2020-05-06-12782615-b681cd8c-从入门到精通-分布式文件系统架构-fastdfs-fastdfs-nginx整合-合并存储-存储缩略图-图片压缩-jav/images/img_061_261545dcf087.png)
