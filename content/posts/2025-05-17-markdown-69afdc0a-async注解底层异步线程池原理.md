{
  ...
  "has_date": true,
  "description": "前言 开发中我们经常会用到异步方法调用，具体到代码层面，异步方法调用的实现方式有很多种，比如最原始的通过实现Runnable接口或者继承Thread类创建异步线程，然后启动异步线程；再如，可以直接用java.util.concurrent包提供的线程池相关API实现异步方法调用。 如果说可以用一行代",
  "tags": [
    "框架",
    "Spring"
  ],
  "source": "local-markdown-library",
  "source_path": "framework/spring/spring-async - Async注解底层异步线程池原理.md",
  "date": "2025-05-17"
...
### [Async注解定义源码](#async注解定义源码)
![](/imported/markdown/2025-05-17-markdown-69afdc0a-async注解底层异步线程池原理/images/adcc2d9fc061-202406150047558.webp)
...
### [Async注解异步调用实现原理概述](#async注解异步调用实现原理概述)
...
## [获取Async注解线程池主流程解析](#获取async注解线程池主流程解析)
...
![AsyncExecutionInterceptor#invoke](/imported/markdown/2025-05-17-markdown-69afdc0a-async注解底层异步线程池原理/images/61a4c8902ffb-202406150047555.webp)AsyncExecutionInterceptor#invoke
下图是determineAsyncExecutor方法实现：
![AsyncExecutionInterceptor#determineAsyncExecutor](/imported/markdown/2025-05-17-markdown-69afdc0a-async注解底层异步线程池原理/images/c3bfb49d880e-202406150047564.webp)AsyncExecutionInterceptor#determineAsyncExecutor![AsyncExecutionAspectSupport#getExecutorQualifier](/imported/markdown/2025-05-17-markdown-69afdc0a-async注解底层异步线程池原理/images/d3f91dbc92f3-202406150047570.webp)AsyncExecutionAspectSupport#getExecutorQualifier
从代码实现中可以看到determineAsyncExecutor获取线程池的大致流程：
![](/imported/markdown/2025-05-17-markdown-69afdc0a-async注解底层异步线程池原理/images/9540fc031cff-202406150047581.webp)
如果在使用Async注解时指定了自定义线程池比较好理解，如果使用Async注解时没有指定自定义线程池，Spring是怎么处理默认线程池呢？继续深入源码看看Spring提供的默认线程池的实现。

## [Spring是怎么为Async注解提供默认线程池的](#spring是怎么为async注解提供默认线程池的)
...
![AsyncExecutionInterceptor#getDefaultExecutor](/imported/markdown/2025-05-17-markdown-69afdc0a-async注解底层异步线程池原理/images/84759bb199ee-202406150047553.webp)AsyncExecutionInterceptor#getDefaultExecutor
...
![AsyncExecutionAspectSupport#getDefaultExecutor](/imported/markdown/2025-05-17-markdown-69afdc0a-async注解底层异步线程池原理/images/2f53d8885e21-202406150047532.webp)AsyncExecutionAspectSupport#getDefaultExecutor
...
![TaskExecutionAutoConfiguration](/imported/markdown/2025-05-17-markdown-69afdc0a-async注解底层异步线程池原理/images/ce0ef4350bc2-202406150047620.webp)TaskExecutionAutoConfiguration![TaskExecutionProperties](/imported/markdown/2025-05-17-markdown-69afdc0a-async注解底层异步线程池原理/images/39c15421bced-202406150047632.webp)TaskExecutionProperties
...
![](/imported/markdown/2025-05-17-markdown-69afdc0a-async注解底层异步线程池原理/images/50b1eb404162-202406150047614.webp)
