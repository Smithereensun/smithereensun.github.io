{
  ...
  "has_date": true,
  "description": "CAP 理论 CAP理论起源于 2000 年，由加州大学伯克利分校的 Eric Brewer 教授在分布式计算原理研讨会（PODC）上提出，因此 CAP 定理又被称作 **布鲁尔定理（Brewer’s theorem）** 年后，麻省理工学院的 Seth Gilbert 和 Nancy Lynch ",
  "tags": [
    "微服务"
  ],
  "source": "local-markdown-library",
  "source_path": "microservices/protocol/cap-base - CAP与BASE：分布式系统设计的灵魂与妥协.md",
  "date": "2025-05-17"
...
![](/imported/markdown/2025-05-17-markdown-81fdb1a3-cap与base-分布式系统设计的灵魂与妥协/images/df13bdcd5eed-202404271617471.png)
...
![](/imported/markdown/2025-05-17-markdown-81fdb1a3-cap与base-分布式系统设计的灵魂与妥协/images/5b5927a12cb7-202501152103375.png)
...
![](/imported/markdown/2025-05-17-markdown-81fdb1a3-cap与base-分布式系统设计的灵魂与妥协/images/2211ff8d0a1c-202404271618759.png)
...
![](/imported/markdown/2025-05-17-markdown-81fdb1a3-cap与base-分布式系统设计的灵魂与妥协/images/8cbbffa4fe73-202404271618435.png)
#### [基本可用](#基本可用)
...
![](/imported/markdown/2025-05-17-markdown-81fdb1a3-cap与base-分布式系统设计的灵魂与妥协/images/a7aad93b7004-202502122027037.png)
**基本可用的核心特性**：
...
![](/imported/markdown/2025-05-17-markdown-81fdb1a3-cap与base-分布式系统设计的灵魂与妥协/images/9c267b9f6c6f-202502122031540.png)
**Soft State 的核心特性**：
...
![](/imported/markdown/2025-05-17-markdown-81fdb1a3-cap与base-分布式系统设计的灵魂与妥协/images/ebe3899b2346-202502122034276.png)
**最终一致性的核心特性**：
