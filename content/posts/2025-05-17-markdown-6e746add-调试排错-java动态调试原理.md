{
  ...
  "has_date": true,
  "description": "来源美团技术团队 简介 断点调试是我们最常使用的调试手段，它可以获取到方法执行过程中的变量信息，并可以观察到方法的执行路径。但断点调试会在断点位置停顿，使得整个应用停止响应。在线上停顿应用是致命的，动态调试技术给了我们创造新的调试模式的想象空间。 本文将研究Java语言中的动态调试技术，首先概括Ja",
  "tags": [
    "Java",
    "JVM"
  ],
  "source": "local-markdown-library",
  "source_path": "java/jvm/03-debug3-dynamicdebug - 调试排错 - Java动态调试原理.md",
  "date": "2025-05-17"

}

来源[美团技术团队](https://tech.meituan.com/2019/11/07/java-dynamic-debugging-technology.html)
...
将编写的Agent打成 jar 包后，就可以挂载到目标JVM上去了。如果选择在目标JVM启动时加载Agent，则可以使用 “-javaagent:[=]“，具体的使用方法可以使用“Java -Help”来查看。如果想要在运行时挂载Agent到目标JVM，就需要做一些额外的开发了。

com.sun.tools.attach.VirtualMachine 这个类代表一个JVM抽象，可以通过这个类找到目标JVM，并且将Agent挂载到目标JVM上。下面是使用com.sun.tools.attach.VirtualMachine 进行动态挂载Agent的一般实现：
...
上面的代码片段截取自hotspot/src/share/vm/runtime/arguments.cpp中的 ArgumentsFlags origin) 函数，该函数用来解析一个具体的JVM参数。这段代码的主要功能是解析出需要加载的Agent路径，然后调用add_init_agent函数进行解析结果的存储。下面先看一下add_init_agent函数的具体实现：
...
![image-20240425190558976](/imported/markdown/2025-05-17-markdown-6e746add-调试排错-java动态调试原理/images/5fd29db5b144-202404251905067.png)image-20240425190558976
...
![image-20240425190843350](/imported/markdown/2025-05-17-markdown-6e746add-调试排错-java动态调试原理/images/2ba685df9f72-202404251908459.png)image-20240425190843350
...
![image-20240425190938842](/imported/markdown/2025-05-17-markdown-6e746add-调试排错-java动态调试原理/images/a640ead6b538-202404251909941.png)image-20240425190938842
下面对每一层做简单介绍：
...
![image-20240425190949873](/imported/markdown/2025-05-17-markdown-6e746add-调试排错-java动态调试原理/images/213f3f33d565-202404251909969.png)image-20240425190949873
...
![image-20240425190959546](/imported/markdown/2025-05-17-markdown-6e746add-调试排错-java动态调试原理/images/54b55ab18631-202404251909632.png)image-20240425190959546
...
![image-20240425191006526](/imported/markdown/2025-05-17-markdown-6e746add-调试排错-java动态调试原理/images/3637c1cefd2d-202404251910623.png)image-20240425191006526
...
![image-20240425191016750](/imported/markdown/2025-05-17-markdown-6e746add-调试排错-java动态调试原理/images/c20bc2f0df8d-202404251910843.png)image-20240425191016750
...
![1714043465647](/imported/markdown/2025-05-17-markdown-6e746add-调试排错-java动态调试原理/images/9f997d603fab-202404251911472.jpg)1714043465647
