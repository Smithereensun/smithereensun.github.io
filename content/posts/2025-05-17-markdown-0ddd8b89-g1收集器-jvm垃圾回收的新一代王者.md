{
  ...
  "title": "G1收集器：JVM垃圾回收的新一代王者",
  "has_date": true,
  "description": "介绍 G1垃圾收集器在JDK7被开发出来，JDK8功能基本完全实现。并且成功替换掉了Parallel Scavenge成为了服务端模式下默认的垃圾收集器。JDK 9以后默认使用，替代了CMS 收集器。 G1和CMS一样，也是采用三色标记分段式进行回收的算法， 不过它是**写屏障 + STAB快照**",
  "tags": [
    "Java",
    "JVM"
  ],
  "source": "local-markdown-library",
  "source_path": "java/jvm/02-gc2-g1 - G1收集器：JVM垃圾回收的新一代王者.md",
  "date": "2025-05-17"
...
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/9d9ccb8e1d8d-202404251706240.jpg)
...
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/3562c4c7b8f2-202404251706079.jpg)
...
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/c5cb6729a193-202406270113919.webp)
...
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/52b0f53c5540-202404251706255.gif)
### [Rset记忆集合](#rset记忆集合)
...
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/e33255ef1407-202406270115756.webp)
...
#### [Per Region Table (PRT)](#per-region-table-prt)
...
CSet收集示意图
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/cc6f4a0fad4b-202404251706247.gif)
...
#### [年轻代收集集合 CSet of Young Collection](#年轻代收集集合-cset-of-young-collection)
...
#### [混合收集集合 CSet of Mixed Collection](#混合收集集合-cset-of-mixed-collection)
...
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/acfd93c8c2c9-202406272232667.webp)
...
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/dd9f1dfd601e-202406272232664.webp)
第二轮检查，检查被GC Roots引用的对象，并标记为灰色
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/19801d7ee5ed-202406272232642.webp)
第三轮检查，循环之前的步骤，将被标记为灰色对象的子Field检查。因为这里就假设了3次循环检查的对象，所以是最后一次检查。这一路检查结束，还是白色的对象就是可以被回收的对象。即图例里的objectC
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/6366d7a633f1-202406272232650.webp)
...
1. 新产生的对象被漏标：这个对象被已经被标记为黑色的对象持有。比如图例中的newObjectF。因为黑色对象已经被认为是检查完毕了，所以新产生的对象不会再被检查，这也会导致漏标。

![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/f547ec569b7d-202406272232645.webp)
有两种被漏标的情况

### [已经存在的对象被漏标](#已经存在的对象被漏标)

即图例中被漏标的objectD，要漏标objectD，必须同时满足：

1. 灰色对象不再指向白色对象，即objectB.d = null

1. 黑色对象指向白色对象，即objectA.d = objectD
...
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/dd9adb2194ec-202406272249868.webp)
### [**为什么G1采用SATB而不用incremental update**？](#为什么g1采用satb而不用incremental-update)
...
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/f18958eb7e82-202406272252376.webp)
...
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/6c6c4664c311-202406272252393.webp)
...
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/82e8347a55ec-202406272252387.webp)
...
### [拷贝存活对象evacuation](#拷贝存活对象evacuation)
...
### [G1垃圾收集活动汇总](#g1垃圾收集活动汇总)
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/ce952b8a720a-202404251706104.jpg)
### [RSet的维护](#rset的维护)
...
栅栏代码示意
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/0c0cd1769786-202404251706125.jpg)
...
#### [起始快照算法Snapshot at the beginning (SATB)](#起始快照算法snapshot-at-the-beginning-satb)
...
#### [并发优化线程Concurrence Refinement Threads](#并发优化线程concurrence-refinement-threads)
...
### [并发标记周期 Concurrent Marking Cycle](#并发标记周期-concurrent-marking-cycle)
...
#### [并发标记线程 Concurrent Marking Threads](#并发标记线程-concurrent-marking-threads)

并发标记位图过程
![](/imported/markdown/2025-05-17-markdown-0ddd8b89-g1收集器-jvm垃圾回收的新一代王者/images/3606465c6ad5-202404251706148.jpg)
...
#### [初始标记 Initial Mark](#初始标记-initial-mark)
...
#### [根分区扫描 Root Region Scanning](#根分区扫描-root-region-scanning)
...
#### [并发标记 Concurrent Marking](#并发标记-concurrent-marking)
...
#### [年轻代收集 Young Collection](#年轻代收集-young-collection)
...
### [并发标记周期后的年轻代收集 Young Collection Following Concurrent Marking Cycle](#并发标记周期后的年轻代收集-young-collection-following-concurrent-marking-cycle)

当G1发起并发标记周期之后，并不会马上开始混合收集。G1会先等待下一次年轻代收集，然后在该收集阶段中，确定下次混合收集的CSet(Choose CSet)。

#### [混合收集周期 Mixed Collection Cycle](#混合收集周期-mixed-collection-cycle)
...
#### [转移失败的担保机制 Full GC](#转移失败的担保机制-full-gc)
