{
  ...
  "title": "Redis的内存碎片问题",
  "has_date": true,
  "description": "什么是内存碎片 可以将内存碎片简单地理解为那些不可用的空闲内存。 当数据删除后，Redis 释放的内存空间会由内存分配器管理，并不会立即返回给操作系统。所以，操作系统仍然会记录着给 Redis 分配了大量内存。而Redis 释放的内存空间可能并不是连续的，那么，这些不连续的内存空间很有可能处于一种闲",
  "tags": [
    "数据库",
    "Redis"
  ],
  "source": "local-markdown-library",
  "source_path": "database/redis/06-tuning3-memoryfragmentationissue - Redis的内存碎片问题.md",
  "date": "2025-05-17"
...
zmalloc 方法源码如下（源码地址：[https://github.com/antirez/redis-tools/blob/master/zmalloc.c）：](https://github.com/antirez/redis-tools/blob/master/zmalloc.c%EF%BC%89%EF%BC%9A)
...
![](/imported/markdown/2025-05-17-markdown-80cbee3b-redis的内存碎片问题/images/3f55f09bf3bb-202404270811288.png)
...
![](/imported/markdown/2025-05-17-markdown-80cbee3b-redis的内存碎片问题/images/abe65c596bbf-202404270811464.png)
...
## [如何查看 Redis 内存碎片？](#如何查看-redis-内存碎片)
...
![](/imported/markdown/2025-05-17-markdown-80cbee3b-redis的内存碎片问题/images/7e45c0d3c3b5-202404270811308.png)
