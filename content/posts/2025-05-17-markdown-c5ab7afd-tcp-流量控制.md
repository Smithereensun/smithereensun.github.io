{
  ...
  "title": "TCP - 流量控制",
  "has_date": true,
  "description": "重传机制 超时重传 重传机制的其中一个方式，就是在发送数据时，设定一个定时器，当**超过指定的时间后**，没有收到对方的 ACK 确认应答报文，就会重发该数据 超时触发重传存在的问题是，超时周期可能相对较长。 快速重传 快速重传不以时间为驱动，而是以数据驱动重传。 快速重传的工作方式是**当收到三个",
  "tags": [
    "计算机基础"
  ],
  "source": "local-markdown-library",
  "source_path": "cs-basics/network/02-tcp2-flowcontrol - TCP - 流量控制.md",
  "date": "2025-05-17"
...
![](/imported/markdown/2025-05-17-markdown-c5ab7afd-tcp-流量控制/images/644d52e49c20-202404271113882.png)
...
![](/imported/markdown/2025-05-17-markdown-c5ab7afd-tcp-流量控制/images/5cc4a6b2ed54-202404271113152.png)
...
![](/imported/markdown/2025-05-17-markdown-c5ab7afd-tcp-流量控制/images/dd91e4c19791-202404271113209.png)
...
![](/imported/markdown/2025-05-17-markdown-c5ab7afd-tcp-流量控制/images/33c2385ad70c-202407071448253.jpg)
### [TCP粘包](#tcp粘包)
...
![](/imported/markdown/2025-05-17-markdown-c5ab7afd-tcp-流量控制/images/ec5b1802031a-202404271113813.png)
...
![](/imported/markdown/2025-05-17-markdown-c5ab7afd-tcp-流量控制/images/40ae76722438-202404271113809.png)
...
![](/imported/markdown/2025-05-17-markdown-c5ab7afd-tcp-流量控制/images/385665634946-202404271113123.png)
...
1. 如果再收到重复的 ACK，那么 cwnd 增加 1；
 如果收到新数据的 ACK 后，把 cwnd 设置为第一步中的 ssthresh 的值，原因是该 ACK 确认了新的数据，说明从 duplicated ACK 时的数据都已收到，该恢复过程已经结束，可以回到恢复之前的状态了，也即再次进入拥塞避免状态；

![](/imported/markdown/2025-05-17-markdown-c5ab7afd-tcp-流量控制/images/569ba91f0101-202404271113656.png)
