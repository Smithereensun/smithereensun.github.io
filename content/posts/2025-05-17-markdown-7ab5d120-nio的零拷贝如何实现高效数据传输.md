{
  ...
  "has_date": true,
  "description": "Java NIO零拷贝 在 Java NIO 中的**通道（Channel）就相当于操作系统的内核空间**（kernel space）的缓冲区，而**缓冲区**（Buffer）对应的相当于操作系统的**用户空间**（user space）中的**用户缓冲区**（user buffer）。 通道**（",
  "tags": [
    "Java"
  ],
  "source": "local-markdown-library",
  "source_path": "java/io/04-networkprogramming2-niozerocopy - NIO的零拷贝如何实现高效数据传输？.md",
  "date": "2025-05-17"
...
![](/imported/markdown/2025-05-17-markdown-7ab5d120-nio的零拷贝如何实现高效数据传输/images/f437685d199e-202406242129630.png)
...
![](/imported/markdown/2025-05-17-markdown-7ab5d120-nio的零拷贝如何实现高效数据传输/images/f1d5706aebec-202406241505120.jpeg)
