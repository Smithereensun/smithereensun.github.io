{
  ...
  "has_date": true,
  "description": "什么是JVM 定义：Java Virtual Machine，JAVA程序的运行环境（JAVA二进制字节码的运行环境） 内存结构 JVM 内存布局规定了 Java 在运行过程中内存申请、分配、管理的策略，保证了 JVM 的高效稳定运行。不同的 JVM 对于内存的划分方式和管理机制存在着部分差异。这也",
  "tags": [
    "Java",
    "JVM"
  ],
  "source": "local-markdown-library",
  "source_path": "java/jvm/01-jvmbasic3-jvmmemorystructure - JVM内存结构：揭秘Java程序运行的底层基石.md",
  "date": "2025-05-17"
...
![](/imported/markdown/2025-05-17-markdown-c833b7f8-jvm内存结构-揭秘java程序运行的底层基石/images/80ac57e96861-202404251633013.gif)
## [内存结构](#内存结构)

JVM 内存布局规定了 Java 在运行过程中内存申请、分配、管理的策略，保证了 JVM 的高效稳定运行。不同的 JVM 对于内存的划分方式和管理机制存在着部分差异。这也就是常说的**运行时数据区**
![](/imported/markdown/2025-05-17-markdown-c833b7f8-jvm内存结构-揭秘java程序运行的底层基石/images/c51543fdf40c-202404251633027.gif)
### [程序计数器](#程序计数器)
...
1. 在多线程的情况下，程序计数器用于记录当前线程执行的位置，当线程被切换回来的时候能够知道它上次执行的位置。
...
##### [stackOverflowError发生原因](#stackoverflowerror发生原因)

- 虚拟机栈中，栈帧过多（无限递归）

- 每个栈帧所占用内存过大

##### [OutOfMemoryError发生原因](#outofmemoryerror发生原因)
...
![](/imported/markdown/2025-05-17-markdown-c833b7f8-jvm内存结构-揭秘java程序运行的底层基石/images/4634d8476540-202404251633019.gif)
...
![](/imported/markdown/2025-05-17-markdown-c833b7f8-jvm内存结构-揭秘java程序运行的底层基石/images/f13d0eaf4cfa-202411302054354.png)
#### [逃逸分析技术](#逃逸分析技术)
...
![](/imported/markdown/2025-05-17-markdown-c833b7f8-jvm内存结构-揭秘java程序运行的底层基石/images/a72a0fad74de-202404251633044.gif)
##### [逃逸分析的好处](#逃逸分析的好处)
...
![](/imported/markdown/2025-05-17-markdown-c833b7f8-jvm内存结构-揭秘java程序运行的底层基石/images/bc6c3a3c4fc9-202404251633055.jpg)
...
其内存模型如下：
![](/imported/markdown/2025-05-17-markdown-c833b7f8-jvm内存结构-揭秘java程序运行的底层基石/images/02c010a4acea-202404251633035.gif)
