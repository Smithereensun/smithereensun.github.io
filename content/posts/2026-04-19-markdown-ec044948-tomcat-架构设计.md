{
  ...
  "title": "Tomcat - 架构设计",
  "has_date": true,
  "description": "引入 Tomcat和Catalina是什么关系？ Tomcat的前身为Catalina，Catalina又是一个轻量级的Servlet容器。在美国，catalina是一个很美的小岛。所以Tomcat作者的寓意可能是想把Tomcat设计成一个优雅美丽且轻量级的web服务器。Tomcat从4.x版本开始",
  "tags": [
    "框架",
    "Web"
  ],
  "source": "local-markdown-library",
  "source_path": "framework/web/tomcat-arch - Tomcat - 架构设计.md",
  "date": "2026-04-19"
...
![](/imported/markdown/2026-04-19-markdown-ec044948-tomcat-架构设计/images/4a418e20c9b1-202603081022091.png)
核心架构组成：
...
### [从web.xml配置和模块对应角度](#从web-xml配置和模块对应角度)
