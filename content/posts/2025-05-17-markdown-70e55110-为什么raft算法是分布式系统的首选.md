{
  ...
  "has_date": true,
  "description": "背景 当今的数据中心和应用程序在高度动态的环境中运行，为了应对高度动态的环境，它们通过额外的服务器进行横向扩展，并且根据需求进行扩展和收缩。同时，服务器和网络故障也很常见。 因此，系统必须在正常操作期间处理服务器的上下线。它们必须对变故做出反应并在几秒钟内自动适应；对客户来说的话，明显的中断通常是不",
  "tags": [
    "微服务"
  ],
  "source": "local-markdown-library",
  "source_path": "microservices/protocol/raft-detail - 为什么Raft算法是分布式系统的首选？.md",
  "date": "2025-05-17"
...
### [任期](#任期)
![](/imported/markdown/2025-05-17-markdown-70e55110-为什么raft算法是分布式系统的首选/images/fc80da28b828-202501152204897.png)
...
三类角色的变迁图如下：
![](/imported/markdown/2025-05-17-markdown-70e55110-为什么raft算法是分布式系统的首选/images/fe6fd72d665d-202501152159526.png)
### [日志](#日志)
...
![](/imported/markdown/2025-05-17-markdown-70e55110-为什么raft算法是分布式系统的首选/images/e329401dfb4b-202501152209969.png)
...
1. Leader在本地生成一个新的log entry，其内容是Cold∪Cnew，代表当前时刻新旧成员配置共存，写入本地日志，同时将该log entry复制至Cold∪Cnew中的所有副本。在此之后新的日志同步需要保证得到Cold和Cnew两个多数派的确认；
...
## [Multi Paxos 、Raft 、ZAB 的关系与区别](#multi-paxos-、raft-、zab-的关系与区别)
