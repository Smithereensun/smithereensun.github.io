{
  ...
  "has_date": true,
  "description": "MyBatis数据源DataSource分类 MyBatis把数据源DataSource分为三种： UNPOOLED 不使用连接池的数据源 POOLED 使用连接池的数据源 JNDI 使用JNDI实现的数据源 相应地，MyBatis内部分别定义了实现了java.sql.DataSource接口的Un",
  "tags": [
    "框架",
    "ORM"
  ],
  "source": "local-markdown-library",
  "source_path": "framework/orm/mybatis-datasourcesandconnectionpools - MyBatis数据源与连接池的全解析.md",
  "date": "2025-05-17"

}

## [MyBatis数据源DataSource分类](#mybatis数据源datasource分类)
...
![](/imported/markdown/2025-05-17-markdown-4714adf2-mybatis数据源与连接池的全解析/images/02a7e589d08d-202411301327658.png)
对于JNDI类型的数据源DataSource，则是通过JNDI上下文中取值。

## [官网DataSource配置内容清单](#官网datasource配置内容清单)
...
## [DataSource的创建过程](#datasource的创建过程)
...
其类图如下所示：
![](/imported/markdown/2025-05-17-markdown-4714adf2-mybatis数据源与连接池的全解析/images/153becd89a44-202411301327671.png)
MyBatis创建了DataSource实例后，会将其放到Configuration对象内的Environment对象中，供以后使用。

## [DataSource什么时候创建Connection对象](#datasource什么时候创建connection对象)
...
## [不使用连接池的UnpooledDataSource](#不使用连接池的unpooleddatasource)
...
上述的序列图如下所示：
![](/imported/markdown/2025-05-17-markdown-4714adf2-mybatis数据源与连接池的全解析/images/9aacc56f4cf4-202411301327313.png)
...
上述程序的执行结果为：
![](/imported/markdown/2025-05-17-markdown-4714adf2-mybatis数据源与连接池的全解析/images/7d784129fff5-202404291756809.png)
...
## [使用了连接池的PooledDataSource](#使用了连接池的pooleddatasource)
...
![](/imported/markdown/2025-05-17-markdown-4714adf2-mybatis数据源与连接池的全解析/images/c850b3af153b-202411301328874.png)
...
对应的处理流程图如下所示：
![](/imported/markdown/2025-05-17-markdown-4714adf2-mybatis数据源与连接池的全解析/images/9e439793658c-202411301328722.png)
...
## [JNDI类型的数据源DataSource](#jndi类型的数据源datasource)
