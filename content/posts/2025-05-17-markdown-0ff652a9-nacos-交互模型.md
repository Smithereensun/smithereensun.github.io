{
  ...
  "title": "Nacos - 交互模型",
  "has_date": true,
  "description": "Nacos在做配置中心的时候，配置数据的交互模式是服务端推过来还是客户端主动拉的？ 这里我先抛出答案：客户端主动拉的！那么它具体是如何实现的？ 配置中心 聊Nacos之前简单回顾下配置中心的由来。 简单理解配置中心的作用就是对配置统一管理，修改配置后应用可以动态感知，而无需重启。 因为在传统项目中，",
  "tags": [
    "微服务",
    "Nacos"
  ],
  "source": "local-markdown-library",
  "source_path": "microservices/service-registration-and-discovery/nacos-interactionmodel - Nacos - 交互模型.md",
  "date": "2025-05-17"
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/03d3f7224405-202404292053648.png)
## [推与拉模型](#推与拉模型)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/b36e4e173361-202404292053348.png)
为了解决短轮询的问题，有了长轮询方案。
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/85cb248f40c0-202404292053153.png)
## [Nacos初识](#nacos初识)

为了后续演示操作方便我在本地搭了个Nacos。**注意：** 运行时遇到个小坑，由于Nacos默认是以cluster集群的方式启动，而本地搭建通常是单机模式standalone，这里需手动改一下启动脚本startup.X中的启动模式。
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/f441d335b62e-202404292054690.png)
直接执行/bin/startup.X就可以了，默认用户密码均是nacos。
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/6a06a664abba-202404292054862.png)
### [几个概念](#几个概念)

Nacos配置中心的几个核心概念：dataId、group、namespace，它们的层级关系如下图：
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/297cab83c1e6-202404292054460.png)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/76fe9fade8ad-202404292054774.png)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/48eeecf63d18-202404292054969.png)
这里我省略了比较多的细节，如鉴权、负载均衡、高可用方面的设计（其实这部分才是真正值得学的），主要弄清客户端与服务端的数据交互模式。

下边我们以Nacos 2.0.1版本源码分析，2.0以后的版本改动较多，和网上的很多资料略有些不同 地址：[https://github.com/alibaba/nacos/releases/tag/2.0.1](https://github.com/alibaba/nacos/releases/tag/2.0.1)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/b55a842af1be-202404292054813.png)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/5584fa082983-202404292054506.png)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/301ac4d86352-202404292054096.png)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/1ff9abca978d-202404292054588.png)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/b3a54f0f494c-202404292054370.png)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/9addaab4d4aa-202404292054843.png)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/0114835f15c3-202404292054756.png)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/ab6d086c2642-202404292054950.png)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/f38dfa40c3d6-202404292054635.png)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/8cbc92523840-202404292054998.png)
...
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/ec7ef8fd6b66-202404292054332.png)
...
#### [订阅数据变更事件](#订阅数据变更事件)
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/4f4ace654a33-202404292054171.png)
...
DataChangeTask
![](/imported/markdown/2025-05-17-markdown-0ff652a9-nacos-交互模型/images/69531618819a-202404292054820.png)
