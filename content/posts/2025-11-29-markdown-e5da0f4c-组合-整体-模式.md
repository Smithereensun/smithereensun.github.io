{
  ...
  "title": "组合（整体）模式",
  "has_date": true,
  "description": "概述 对于这个图片肯定会非常熟悉，上图我们可以看做是一个文件系统，对于这样的结构我们称之为树形结构。在树形结构中可以通过调用某个方法来遍历整个树，当我们找到某个叶子节点后，就可以对叶子节点进行相关的操作。可以将这颗树理解成一个大的容器，容器里面包含很多的成员对象，这些成员对象可以容器对象也可以是叶子",
  "tags": [
    "系统设计",
    "设计模式"
  ],
  "source": "local-markdown-library",
  "source_path": "system-design/design-pattern/composite - 组合（整体）模式.md",
  "date": "2025-11-29"

}

## [概述](#概述)
![](/imported/markdown/2025-11-29-markdown-e5da0f4c-组合-整体-模式/images/d2432409b81b-202404271758612.png)
...
![](/imported/markdown/2025-11-29-markdown-e5da0f4c-组合-整体-模式/images/0b0cb43f202c-202404271758406.png)
要实现该案例，先画出类图：
![](/imported/markdown/2025-11-29-markdown-e5da0f4c-组合-整体-模式/images/7cc21512904d-202404271758772.png)
**代码实现：**
...
![](/imported/markdown/2025-11-29-markdown-e5da0f4c-组合-整体-模式/images/1abed3cfe9c3-202404271759610.png)
## [优缺点](#优缺点)
...
### [ArrayList 的“类似”与区别](#arraylist-的-类似-与区别)
