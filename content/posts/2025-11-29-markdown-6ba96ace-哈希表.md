{
  ...
  "title": "哈希表",
  "has_date": true,
  "description": "介绍 像线性数据结构在查找的时候，⼀般都是使⽤= 或者!=，在折半查找或者其他范围查询的时候，可能会使⽤&lt; 和&gt; ,理想的时候，我们肯定希望不经过任何的⽐较，直接能定位到某个位置（存储位置），这种在数组中，可以通过索引取得元素。那么，如果我们将需要存储的数据和数组的索引对应起来，并且是⼀",
  "tags": [
    "计算机基础"
  ],
  "source": "local-markdown-library",
  "source_path": "cs-basics/data-structure/hash-table - 哈希表.md",
  "date": "2025-11-29"
...
![](/imported/markdown/2025-11-29-markdown-6ba96ace-哈希表/images/5c58e50fb21f-202502221745416.png)
⼀般常⽤的hash 函数有：
...
![](/imported/markdown/2025-11-29-markdown-6ba96ace-哈希表/images/43510f95eaa3-202502221752613.png)
但是如果hash 冲突⽐较严重，链表会⽐较⻓，查询的时候，需要遍历后⾯的链表，因此JDK 优化了⼀版，链表的⻓度超过阈值的时候，会变成红⿊树，红⿊树有⼀定的规则去平衡⼦树，避免退化成为链表，影响查询效率。
![](/imported/markdown/2025-11-29-markdown-6ba96ace-哈希表/images/8bf01a0cccef-202502221752866.png)
...
![](/imported/markdown/2025-11-29-markdown-6ba96ace-哈希表/images/41b20b2fbf23-202404250653895.png)
...
![](/imported/markdown/2025-11-29-markdown-6ba96ace-哈希表/images/10866ff9b42f-202404250654349.png)![](/imported/markdown/2025-11-29-markdown-6ba96ace-哈希表/images/2d3e0f40297c-202404250654208.png)
#### [平方探测](#平方探测)
...
![](/imported/markdown/2025-11-29-markdown-6ba96ace-哈希表/images/e7f391904a71-202404250654938.png)![](/imported/markdown/2025-11-29-markdown-6ba96ace-哈希表/images/fa2ff065ea9b-202404250654538.png)
