{
  ...
  "title": "AI Agent入门知识",
  "has_date": true,
  "description": "AI Agent到底是什么？ 从概念上来说，AI Agent（智能体）是一种不需要持续人类干预的AI系统，可以基于环境和背景信息，自主分析各种问题，做出逻辑决策，并且在没有持续人类输入的情况下处理多种任务。 AlphaGo就是一个典型的AI Agent，它可以在和人类对弈围棋的过程中，根据当前的棋局",
  "tags": [
    "AI",
    "Agent"
  ],
  "source": "local-markdown-library",
  "source_path": "ai/agent/agent-summary - AI Agent入门知识.md",
  "date": "2026-04-19"

}

## [AI Agent到底是什么？](#ai-agent到底是什么)
...
### [AI Agent的构成](#ai-agent的构成)

#### [构成一、规划Planning](#构成一、规划planning)
...
### [AI Agent有哪些优势和局限？](#ai-agent有哪些优势和局限)
...
### [企业和个人为什么要关注AI Agent？](#企业和个人为什么要关注ai-agent)
...
## [AI Agent的发展历程是怎样的？AI Agent未来的发展趋势是怎样的？](#ai-agent的发展历程是怎样的-ai-agent未来的发展趋势是怎样的)

### [AI Agent的发展历程](#ai-agent的发展历程)

#### [阶段一，LLM大模型时代之前的Agent](#阶段一-llm大模型时代之前的agent)
...
### [AI Agent的未来发展趋势](#ai-agent的未来发展趋势)
...
#### [Function Calling准确性](#function-calling准确性)
...
每个细分领域具体的玩家就不一一列举了，大家可以详细参考下图。另外，这张图是持续更新的，通过这个地址 [https://github.com/e2b-dev/awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents)，大家就能看到最新的进展，以及E2B对每个玩家的详细介绍
![](/imported/markdown/2026-04-19-markdown-82a8bec3-ai-agent入门知识/images/3aae60ca6d22-202505312211535.png)
### [国内AIAgent生态](#国内aiagent生态)
...
## [AI Agent都有哪些可落地的场景](#ai-agent都有哪些可落地的场景)
...
## [如何实现AI Agent？AI Agent包括哪些系统模块？](#如何实现ai-agent-ai-agent包括哪些系统模块)
...
![](/imported/markdown/2026-04-19-markdown-82a8bec3-ai-agent入门知识/images/bf7cd43405b7-202506011105346.jpg)
...
![](/imported/markdown/2026-04-19-markdown-82a8bec3-ai-agent入门知识/images/5492a51e331c-202506011108025.jpg)
...
![](/imported/markdown/2026-04-19-markdown-82a8bec3-ai-agent入门知识/images/8d62ba74393a-202506011114345.jpg)
...
![](/imported/markdown/2026-04-19-markdown-82a8bec3-ai-agent入门知识/images/6994fa3893d5-202506011117239.png)
LLM Compiler主要有以下组件：
...
1. 扩展和执行：生成N个潜在操作，并且并行执行

1. 反思和评估：观察这些行动的结果，并根据反思和外部反馈对决策评分
...
![](/imported/markdown/2026-04-19-markdown-82a8bec3-ai-agent入门知识/images/3384708c5aac-202506011126923.jpg)
