{
  ...
  "title": "递归与分治",
  "has_date": true,
  "description": "递归算法 递归算法（Recursion Algorithm）是一种重要的编程方法，核心思想是**函数通过调用自身**来解决问题。在递归中，一个复杂的问题被分解为相同类型但规模更小的子问题，直到达到一个简单到可以直接解决的基本情况（基准情况）。递归算法特别适合**解决具有自相似结构的问题**，时间复杂",
  "tags": [
    "计算机基础"
  ],
  "source": "local-markdown-library",
  "source_path": "cs-basics/algorithms/recursion - 递归与分治.md",
  "date": "2025-10-28"
...
1. 将子问题的结果组合起来，得到原问题的解

![](/imported/markdown/2025-10-28-markdown-a0b86fda-递归与分治/images/40abf1728682-202510282245180.jpg)
核心特性：
...
1. 解决(Conquer)：若子问题规模较小且容易解决则直接解决，否则递归地解各子问题。

1. 合并(Combine)：将各子问题的解合并为原问题的解。
