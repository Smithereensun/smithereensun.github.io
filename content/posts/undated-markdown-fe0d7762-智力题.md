{
  ...
  "title": "智力题",
  "has_date": false,
  "description": "三人三鬼过桥 有三个人跟三个鬼要过河，河上没桥只有条小船,然后船一次只能渡一个人和一个鬼，或者两个鬼或者两个人，无论在哪边岸上，只有是人比鬼少的情况下(如两鬼一人，三鬼两人，三鬼一人)人会被鬼吃，然而船又一定需要人或鬼操作才能航行(要有人或鬼划船)。问：如何安全的把三人三鬼渡过河对岸? 参考回答 先",
  "tags": [
    "面试"
  ],
  "source": "local-markdown-library",
  "source_path": "interview/intelligence-massivedata/intelligence - 智力题.md"
...
建议画图表来看，将问题简单化一点，将大问题化成小问题即可，同时B站有个讲解视频还不错：[https://www.bilibili.com/video/BV1KJ411g78y](https://www.bilibili.com/video/BV1KJ411g78y)

详细解法：

**1、25匹马5条跑道找最快的3匹马，需要跑几次？**
![](/imported/markdown/undated-markdown-fe0d7762-智力题/images/95bf813125fa-202411232200592.png)
...
![](/imported/markdown/undated-markdown-fe0d7762-智力题/images/cace0a39de0e-202411232207442.png)
第二步：取每组第一名进行一次比赛，然后淘汰最后四名所在组的所有马，如下图（需要比赛1场）
![](/imported/markdown/undated-markdown-fe0d7762-智力题/images/701d1774ab90-202411232208748.png)
这个时候总冠军已经诞生，它就是A1，蓝域（它不需要比赛了）。

而其他可能跑得最快的三匹马只可能是下图中的黄域了（A2,A3,A4,B1,B2,B3,C1,C2,D1，共9匹马）
![](/imported/markdown/undated-markdown-fe0d7762-智力题/images/dae0d23d9ce6-202411232209821.png)
...
![](/imported/markdown/undated-markdown-fe0d7762-智力题/images/ad56a9c1fad6-202411232221263.png)
...
2、十组砝码每组十个，每个砝码都是10g重，但是现在其中**有一组砝码每个都只有9g**重，现有一个能显示克数的秤，最少称几次能找到轻的那组？
...
## [毒药毒白鼠，找出哪个瓶子中是毒药](#毒药毒白鼠-找出哪个瓶子中是毒药)
...
## [在24小时里面时针分针秒针可以重合几次](#在24小时里面时针分针秒针可以重合几次)

24小时中时针走2圈，而分针走24圈，时针和分针重合24-2=22次，而只要时针和分针重合，秒针一定有机会重合，所以总共重合22次？

但时针和分针重合的时候，秒针根本就不在重合的地方，而是在其他地方，以下是数学推导：
![](/imported/markdown/undated-markdown-fe0d7762-智力题/images/6f615042cc18-202411232252143.png)
因此就只有 1 次重合，因为在 12 小时内不包含 12 点这个时间，所以在 24 小时内，也就只有**两次重合**，分别为 0 点和 12 点。

## [100个奴隶猜帽子颜色](#_100个奴隶猜帽子颜色)
...
## [N只蚂蚁走树枝，问总距离或者总时间](#n只蚂蚁走树枝-问总距离或者总时间)
...
1. **最长时间**：
  ...
  - 因此，所有蚂蚁中，最长时间是树枝长度 M*M* 除以蚂蚁的速度。
...
## [N个强盗分配M个金币，求方案使得自己分配最多](#n个强盗分配m个金币-求方案使得自己分配最多)

5个海盗抢到了100枚金币，每一颗都一样的大小和价值。 他们决定这么分：

1. 抽签决定自己的号码（1，2，3，4，5）

1. 首先，由1号提出分配方案，然后大家5人进行表决，当半数以上的人同意时（ 不包括半数，这是重点），按照他的提案进行分配，否则将被扔入大海喂鲨鱼。

1. 如果1号死后，再由2号提出分配方案，然后大家4人进行表决，当且仅当半超过半数的人同意时，按照他的提案进行分配，否则将被扔入大海喂鲨鱼。
