{
  ...
  "has_date": true,
  "description": "ZGC概述 ZGC（The Z Garbage Collector）是JDK 11中推出的一款低延迟垃圾回收器，它的设计目标包括： 停顿时间不超过10ms； 停顿时间不会随着堆的大小，或者活跃对象的大小而增加（对程序吞吐量影响小于15%）； 支持8MB~4TB级别的堆（未来支持16TB）。 从设计目",
  "tags": [
    "Java",
    "JVM"
  ],
  "source": "local-markdown-library",
  "source_path": "java/jvm/02-gc3-zgc - ZGC详解：下一代低延迟垃圾回收器的革命性突破.md",
  "date": "2025-05-17"
...
1. ZGC原理：分析ZGC停顿时间比G1或CMS更短的本质原因，以及背后的技术原理；

1. ZGC调优实践：重点分享对ZGC调优的理解，并分析若干个实际调优案例；

1. 升级ZGC效果：展示在生产环境应用ZGC取得的效果。
...
![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/3c53c36a9cce-202404251714777.jpg)
...
ZGC垃圾回收周期如下图所示：
![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/7ec441354aec-202404251714782.jpg)
...
![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/be64bbb28768-202406272309750.webp)
### [ZGC关键技术](#zgc关键技术)
...
![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/278d30469fc6-202404251714779.jpg)
其中，[0~4TB) 对应Java堆，[4TB ~ 8TB) 称为M0地址空间，[8TB ~ 12TB) 称为M1地址空间，[12TB ~ 16TB) 预留未使用，[16TB ~ 20TB) 称为Remapped空间。

当应用程序创建对象时，首先在堆空间申请一个虚拟地址，但该虚拟地址并不会映射到真正的物理地址。ZGC同时会为该对象在M0、M1和Remapped地址空间分别申请一个虚拟地址，且这三个虚拟地址对应同一个物理地址，但这三个空间在同一时间有且只有一个空间有效。ZGC之所以设置三个虚拟地址空间，是因为它使用“空间换时间”思想，去降低GC停顿时间。“空间换时间”中的空间是虚拟空间，而不是真正的物理空间。后续章节将详细介绍这三个空间的切换过程。

与上述地址空间划分相对应，ZGC实际仅使用64位地址空间的第041位，而第4245位存储元数据，第47~63位固定为0。
![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/8dfab00d20b0-202404251714781.jpg)
...
![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/6320a1a7e53d-202406272313831.webp)
...
![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/15b7f843193d-202406272313821.webp)
...
1. 并发预备重分配(Concurrent Prepare for Relocate)
...
![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/623cde12ca6c-202406272313845.webp)

1. 初始迁移(Relocate Start)
...
![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/9f9217e91967-202406272313837.webp)

1. 并发迁移(Concurrent Relocate)
...
![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/a1d6ebc43feb-202406272313864.webp)
...
![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/583e49ff3752-202404251714790.jpg)
...
![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/69343901ec1c-202404251714615.jpg)
#### [理解ZGC停顿原因](#理解zgc停顿原因)
...
![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/a6eb17afbe40-202404251714641.jpg)

- 安全点：所有线程进入到安全点后才能进行GC，ZGC定期进入安全点判断是否需要GC。先进入安全点的线程需要等待后进入安全点的线程直到所有线程挂起。

- dump线程、内存：比如jstack、jmap命令。

![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/bcc15cc19420-202404251714660.jpg)![](/imported/markdown/2025-05-17-markdown-023e2fdb-zgc详解-下一代低延迟垃圾回收器的革命性突破/images/5a02fec765a9-202404251714679.jpg)
### [调优案例](#调优案例)
