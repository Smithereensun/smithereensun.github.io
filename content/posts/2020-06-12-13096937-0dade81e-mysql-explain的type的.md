...
![](/imported/posts/2020-06-12-13096937-0dade81e-mysql-explain的type的/images/img_001_015a4adbaccd.png)
...
　　ange指的是有范围的索引扫描，相对于index的全索引扫描，它有范围限制，因此要优于index。关于range比较容易理解，需要记住的是出现了range，则一定是基于索引的。同时除了显而易见的between，and以及'>','<'外，in和or也是索引范围扫描。
...
　　转载自：https://blog.csdn.net/dennis211/article/details/78170079
