...
date: 2023-05-31
description: "项目报错：Unable to start web server; nested exception is org.springframework.context.ApplicationContextException 解决方案一 &lt;!-- 使用嵌入式Jetty作为web container -"
tags:
  - "分布式架构"
  - "Spring Boot"
  - "Dubbo"
...
<p>项目报错：Unable to start web server; nested exception is org.springframework.context.ApplicationContextException</p>
<h2>解决方案一</h2>
<div class="cnblogs_code">
<pre><span style="color: rgba(0, 128, 0, 1)">&lt;!--</span><span style="color: rgba(0, 128, 0, 1)"> 使用嵌入式Jetty作为web container </span><span style="color: rgba(0, 128, 0, 1)">--&gt;</span>
